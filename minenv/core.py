...
class SimpleEnvironment(ABC, Generic[ActType, ObsType]):
	r'''
	Main class for simple environments, which should be extended and implemented.
	'''
...
class EnvironmentNotResetError(Exception):
	...
	'''
	def __init__(self, message: str = "The environment must be reset before a step is taken."):
		self.message = message
		super(EnvironmentNotResetError, self).__init__(self.message)
